...
function WaterTracker() {
    return (
        <section className="p-8 max-w-md mx-auto flex-1">
            <article className="bg-white p-6 rounded-[1rem] shadow-sm border border-slate-100" style={{ width: '300px'}}>
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-semibold">Vattenintag <Droplet className="text-accent" /></h2>
